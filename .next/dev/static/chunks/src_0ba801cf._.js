...
;
;
const World = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/ui/globe.tsx [app-client] (ecmascript, next/dynamic entry, async loader)").then((m)=>m.World), {
    loadableGenerated: {
        modules: [
...
function parseColor(color) {
    ...
    // Use a temporary canvas to let the browser parse the color for us
...
const DitherShader = ({ src, gridSize = 4, ditherMode = "bayer", colorMode = "original", invert = false, pixelRatio = 1, primaryColor = "#000000", secondaryColor = "#ffffff", customPalette = [
    ...
    const parsedPrimaryColor = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "DitherShader.useMemo[parsedPrimaryColor]": ()=>parseColor(primaryColor)
    }["DitherShader.useMemo[parsedPrimaryColor]"], [
        primaryColor
    ]);
    const parsedSecondaryColor = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "DitherShader.useMemo[parsedSecondaryColor]": ()=>parseColor(secondaryColor)
    }["DitherShader.useMemo[parsedSecondaryColor]"], [
        secondaryColor
    ]);
    const parsedCustomPalette = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "DitherShader.useMemo[parsedCustomPalette]": ()=>customPalette.map(parseColor)
    }["DitherShader.useMemo[parsedCustomPalette]"], [
        customPalette
    ]);
    // Determine the effective color mode
    const effectiveColorMode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "DitherShader.useMemo[effectiveColorMode]": ()=>{
            if (colorMode !== "original") return colorMode;
            // If we're in original mode but primary/secondary colors are provided, 
            // we should probably be in duotone mode if they aren't the defaults.
            if (primaryColor !== "#000000" || secondaryColor !== "#ffffff") {
                return "duotone";
            }
            return "original";
        }
        ...
        "DitherShader.useCallback[applyDithering]": (ctx, displayWidth, displayHeight, time = 0)=>{
            ...
            for(let y = 0; y < displayHeight; y += effectivePixelSize){
                for(let x = 0; x < displayWidth; x += effectivePixelSize){
                    ...
                    // Draw the pixel
                    ctx.fillStyle = `rgba(${outputColor[0]}, ${outputColor[1]}, ${outputColor[2]}, ${outputColor[3] / 255})`;
...
_s(DitherShader, "xd9Tz/u9C9kU9jcS52jcEzndKPc=");
_c = DitherShader;
...
//# sourceMappingURL=src_0ba801cf._.js.map